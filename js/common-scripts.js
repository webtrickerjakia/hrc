(function ($) {
 ...
 // Phone nav click function
       $('.hamburger').click(function () {
        ...
        $(".left-nav ul > li").find(".mega-menu").parent("li").addClass("has-sub-nav");
        if($(window).width()<=768){
        $(".left-nav ul > li.has-sub-nav > a").bind('click', 'touchend', function (e) {
            e.preventDefault();
            $(".left-nav ul > li").find("> .mega-menu:visible").slideUp()
...
$('.hero-item').slick({
    dots: false,
    speed: 800,          // fade smooth করার জন্য একটু বেশি speed
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 1000, // চাইলে change করতে পারেন
    fade: true,
